...
class TestDirectivesClient:
    ...
    def test_record_directive(self, learn_client, clean_tables):
        ...
        fact_id = learn_client.directives.record(
        ...
        fact = learn_client.directives.get(fact_id)
    ...
    def test_set_status(self, learn_client, clean_tables):
        ...
        fact_id = learn_client.directives.record(text="Test directive")

        # Pause
        result = learn_client.directives.set_status(fact_id, "paused")
        ...
        # Complete
        learn_client.directives.set_status(fact_id, "completed")
        fact = learn_client.directives.get(fact_id)
    ...
    def test_set_status_not_found(self, learn_client, clean_tables):
        ...
        result = learn_client.directives.set_status(99999, "paused")
        assert result is False

    def test_set_status_invalid_raises(self, learn_client, clean_tables):
        """Test that invalid status raises ValidationError."""
        fact_id = learn_client.directives.record(text="Test")

        with pytest.raises(ValidationError, match="Invalid status"):
            learn_client.directives.set_status(fact_id, "invalid")
    ...
    def test_list_active(self, learn_client, clean_tables):
        ...
        fact_id = learn_client.directives.record(text="To be paused")
        learn_client.directives.record(text="Active 2")

        # Pause one
        learn_client.directives.set_status(fact_id, "paused")
    ...
    def test_count_by_status(self, learn_client, clean_tables):
        ...
        fact_id = learn_client.directives.record(text="B")
        ...
        paused = learn_client.directives.list_by_type("standing", include_inactive=True)
