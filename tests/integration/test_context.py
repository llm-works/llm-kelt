...
class TestContextBuilder:
    ...
    def test_build_empty_prompt_no_facts(self, learn_client, clean_tables):
        ...
        builder = ContextBuilder(learn_client.assertions)
    ...
    def test_build_prompt_with_facts(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Response format: markdown")
        learn_client.assertions.add("Timezone: UTC")
    ...
    def test_build_prompt_facts_prepend(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Output language: English")
    ...
    def test_build_prompt_grouped_by_category(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Code style: verbose", category="preferences")
        learn_client.assertions.add("Include examples: yes", category="preferences")
        learn_client.assertions.add("Domain: backend systems", category="context")
    ...
    def test_build_prompt_uncategorized_no_headers(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Fact without category")
        learn_client.assertions.add("Another uncategorized fact")
    ...
    def test_build_prompt_filter_by_category(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Config B", category="settings")
    ...
    def test_build_prompt_filter_by_min_confidence(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("High confidence fact", confidence=0.9)
        learn_client.assertions.add("Low confidence fact", confidence=0.3)
    ...
    def test_build_prompt_excludes_inactive(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Active fact")
    ...
    def test_build_prompt_max_facts(self, learn_client, clean_tables):
        ...
        for i in range(10):
            learn_client.assertions.add(f"Fact {i}")
    ...
    def test_get_facts_summary(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Pref 1", category="preferences")
        learn_client.assertions.add("Pref 2", category="preferences")
        learn_client.assertions.add("Setting X", category="settings", confidence=0.8)
    ...
    def test_build_empty_base_prompt_with_facts(self, learn_client, clean_tables):
        ...
        learn_client.assertions.add("Some fact")
